...
def create_reviews():
    ...
    reviews.append(Review(comment='{"blocks":[{"key":"2l86g","text":"C\'est neutre mais pas tout à fait","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}}],"entityMap":{}}',
                          content=content,
                          reviewer=reviewer))
    ...
    reviewer = User.query.filter_by(email='{}test.reviewer0@{}.{}'.format(COMMAND_NAME, APP_NAME, TLD)).one()
    reviews.append(Review(comment='{"blocks":[{"key":"2l86g","text":"C\'est pas très précis","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}}],"entityMap":{}}',
                          content=content,
                          reviewer=reviewer))

    content = Content.query.filter_by(url='http://www.dailymail.co.uk/sciencetech/article-4192182/World-leaders-duped-manipulated-global-warming-data.html').one()
    reviewer = User.query.filter_by(email='{}test.reviewer1@{}.{}'.format(COMMAND_NAME, APP_NAME, TLD)).one()
    reviews.append(Review(comment='{"blocks":[{"key":"2l86g","text":"On peut dire que c\'est pourri.","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}}],"entityMap":{}}',
                          content=content,
                          reviewer=reviewer))
