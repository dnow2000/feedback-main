...
exports.getReshapedNormalizer = getReshapedNormalizer;
exports["default"] = void 0;

function getReshapedNormalizer(normalizer) {
  var reshapedNormalizer = {};
  Object.keys(normalizer).forEach(function (datumKey) {
    var stateKeyOrObj = normalizer[datumKey];
    ...
    if (typeof stateKeyOrObj !== 'string') {
      ...
      reshapedNormalizer[datumKey].stateKey = stateKeyOrObj.stateKey ? stateKeyOrObj.stateKey : datumKey;
    } else {
...
var _default = getReshapedNormalizer;
